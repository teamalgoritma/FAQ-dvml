...
### **Jika pada hasil summary model regresi linier terdapat salah satu level/kategori dari prediktor bertipe kategorik yang tidak signifikan mempengaruhi target variabel (p-value kurang dari alpha), apakah prediktor tersebut signifikan mempengaruhi target variabel atau tidak?**
...
### **Apaa saja cara yang dapat dilakukan untuk memperbaiki  model regresi linier (tuning)?**

Berikut beberapa cara yang dapat dilakukan untuk memperbaiki model regresi linier:

1. Deteksi observasi outlier
   - Pengaruh negatif tergdap model regresi linier sebaiknya observasi tersebut tidak diikutsertakan 
