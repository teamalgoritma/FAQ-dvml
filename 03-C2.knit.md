...
Terdapat berbagai cara menangani data yang mengandung missing value. Cara yang paling serig digunkan untuk menangani data yang mengandung missing value, yaitu deletion, full analysis, dan imputation.
...
Sebagai contoh akan digunakan data `credit_data` dari library `caret`
