...
1. Bagaimana cara menambahkan separator (,) untuk memisahkan angka ribuan pada label `geom_text()`/`geom_label()` yang terletak pada setiap batang (bar) di bar plot ?
...
2. Bagaimana cara untuk mengurutkan batang (bar) saat menggunakan `geom_bar()`?
...
3. Bagaimana cara mengubah urutan kategori pada legend?
...
4. Bagaimana cara membuat lebih dari satu line pada satu grafik dengan menggunakan `geom_line`?
...
5. Bagaimana cara untuk menampilkan nilai (value) pada stacked bar?
...
6. Bagaimana cara membuat secondary axis pada `ggplot2`?
...
7. Bagaimana cara membuat multi row axis label pada ggplot?
...
2. Apakah pengaturan label baik pada sumbu x ataupun y dapat dilakukan secara terpisah? misal kita ingin memeberikan label ribuan (1 ribu, 2 ribu, dst). Namun, pada angka 0 tidak ingin diikuti oleh "ribuan".
...
3. Bagaimana mengatasi axis yang memiliki satuan besar seperti berikut ini?
...
4. Bagaimana cara untuk mewarnai dan memberi label pada bar tertentu pada plot?
...
**1. Contoh penggunaan echarts4r untuk beberapa plot sederhana**
...
**2. Bagaimana cara membuat echarts menjadi interaktif?**
...
**3. Contoh penggunaan highcharter untuk beberapa plot sederhana:**
...
**4. Bagaimana cara untuk menampilkan popup informasi dari grafik?**
...
**5. Apakah plotly juga dapat diatur/disesuaikan (custom) secara terpisah dari `ggplot2`? bagaimana caranya?**
